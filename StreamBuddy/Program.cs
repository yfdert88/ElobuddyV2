namespace StreamBuddy
{
    ...
    internal class Program
    {
        ...
        /// </summary>
        public static GameObjectOrder lastOrder;
        ...
        {
            root = MainMenu.AddMenu("RealisticFakeClicks", "RealisticFakeClicks");
            root.AddGroupLabel("StreamSettings");
            root.AddLabel("BY MOSTLYPRIDE w00t, Reworked: SiyahParke");
            root.Add("stream", new CheckBox("Active [SOON]", false));
